  ...
  return (
    <div>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <label className='list-garage-imput'>
                Oficina de Tuning:
                <select value={autoShop} onChange={(e) => setAutoShop(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={bailEnforcement} onChange={(e) => setBailEnforcement(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Bunker:
                <select value={bunker} onChange={(e) => setBunker(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={casinoPenthouse} onChange={(e) => setCasinoPenthouse(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={executiveOfficeGarage1} onChange={(e) => setExecutiveOfficeGarage1(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={executiveOfficeGarage2} onChange={(e) => setExecutiveOfficeGarage2(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={executiveOfficeGarage3} onChange={(e) => setExecutiveOfficeGarage3(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Garagem 1:
                <select value={garage1} onChange={(e) => setGarage1(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Garagem 2:
                <select value={garage2} onChange={(e) => setGarage2(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 3:
                <select value={garage3} onChange={(e) => setGarage3(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 4:
                <select value={garage4} onChange={(e) => setGarage4(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 5:
                <select value={garage5} onChange={(e) => setGarage5(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 6:
                <select value={garage6} onChange={(e) => setGarage6(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 7:
                <select value={garage7} onChange={(e) => setGarage7(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 8:
                <select value={garage8} onChange={(e) => setGarage8(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 9:
                <select value={garage9} onChange={(e) => setGarage9(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                Garagem 10:
                <select value={garage10} onChange={(e) => setGarage10(e.target.value)}>
                    <option value="">Nenhum</option>
                    {properties.garage.map((property) => (
                        <option key={property.value} value={property.value}>({property.capacity} vagas) {property.property}</option>
                    ))}
            ...
            <label className='list-garage-imput'>
                ...
                <select value={vinewoodGarage} onChange={(e) => setVinewoodGarage(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={eclipseBlvdGarage} onChange={(e) => setEclipseBlvdGarage(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Terrorbyte:
                <select value={terrorbyte} onChange={(e) => setTerrorbyte(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Avenger:
                <select value={avenger} onChange={(e) => setAvenger(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Motoclube:
                <select value={clubhouse} onChange={(e) => setClubhouse(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Boate:
                <select value={nightclub} onChange={(e) => setNightclub(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                Arcade:
                <select value={retroArcade} onChange={(e) => setRetroArcade(e.target.value)}>
                    <option value="">Nenhum</option>
            ...
            <label className='list-garage-imput'>
                ...
                <select value={salvageYard} onChange={(e) => setSalvageYard(e.target.value)}>
                    <option value="">Nenhum</option>
